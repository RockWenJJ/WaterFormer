import cv2
import math
import numpy as np  # Add this line to explicitly import NumPy
import os
import torch
...
def img2tensor(imgs, bgr2rgb=True, float32=True):
    ...
    def _totensor(img, bgr2rgb, float32):
        try:
            ...
            raise RuntimeError(f"Invalid image format. Expected numpy array, got {type(img)}")
        except ImportError:
            raise ImportError("NumPy is not installed. Please install NumPy and try again.")
